...
################## configure here ##################
folderAOD = "srm://dcache-se-cms.desy.de/pnfs/desy.de/cms/tier2/store/user/vkutzner/SignalMC-CMSSW8/AODSIM"
outputFolder = "srm://dcache-se-cms.desy.de/pnfs/desy.de/cms/tier2/store/user/vkutzner/DisappTrksNtupleSidecarI7sig"
scenario = "Summer16sig"
filelistFile = open("viktor_filelist.txt", 'r')
################## configure here ##################
...
for fileMiniAOD in filelist:
    ...
    fileAOD = fileMiniAOD.replace("step4", "step3")
