...
################## configure here ##################
folderAOD = "srm://dcache-se-cms.desy.de//pnfs/desy.de/cms/tier2/store/user/aksingh/disaptrks/AODSIM%sCM" % options.length
outputFolder = "srm://dcache-se-cms.desy.de/pnfs/desy.de/cms/tier2/store/user/vkutzner/DisappTrksAkshansh-N1-%sCM" % options.length
scenario = "Summer16sig"
filelistFile = open("filelistAkshansh%s.txt" % options.length, 'r')
################## configure here ##################
...
for fileMiniAOD in filelist:
    ...
    fileAOD = fileMiniAOD.replace("step4_miniAODSIM", "step3_AODSIM")
