...
void DisappearingTrackProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  iEvent.put(std::move(chiCands),                                 "tracks");
  iEvent.put(std::move(chiCands_dxyVtx),                          "tracks@dxyVtx");
  iEvent.put(std::move(chiCands_dzVtx),                           "tracks@dzVtx");
  iEvent.put(std::move(chiCands_pixelLayersWithMeasurement),      "tracks@pixelLayersWithMeasurement");
  iEvent.put(std::move(chiCands_trackerLayersWithMeasurement),    "tracks@trackerLayersWithMeasurement");
  iEvent.put(std::move(chiCands_nMissingOuterHits),               "tracks@nMissingOuterHits");
  iEvent.put(std::move(chiCands_nMissingInnerHits),               "tracks@nMissingInnerHits");
  iEvent.put(std::move(chiCands_nMissingMiddleHits),              "tracks@nMissingMiddleHits");
  iEvent.put(std::move(chiCands_nValidPixelHits),                 "tracks@nValidPixelHits");
  iEvent.put(std::move(chiCands_nValidTrackerHits),               "tracks@nValidTrackerHits");
  iEvent.put(std::move(chiCands_ptError),                         "tracks@ptError");
  iEvent.put(std::move(chiCands_chi2perNdof),                     "tracks@chi2perNdof");
  iEvent.put(std::move(chiCands_trkRelIso),                       "tracks@trkRelIso");
  iEvent.put(std::move(chiCands_trkMiniRelIso),                   "tracks@trkMiniRelIso");
  iEvent.put(std::move(chiCands_trackJetIso),                     "tracks@trackJetIso");
  iEvent.put(std::move(chiCands_trackLeptonIso),                  "tracks@trackLeptonIso");
  iEvent.put(std::move(chiCands_matchedCaloEnergy),               "tracks@matchedCaloEnergy");
  iEvent.put(std::move(chiCands_matchedCaloEnergyJets),           "tracks@matchedCaloEnergyJets");
  iEvent.put(std::move(chiCands_deDxHarmonic2),                   "tracks@deDxHarmonic2");
  iEvent.put(std::move(chiCands_chargedPtSum),                    "tracks@chargedPtSum");
  iEvent.put(std::move(chiCands_neutralPtSum),                    "tracks@neutralPtSum");
  iEvent.put(std::move(chiCands_neutralWithoutGammaPtSum),        "tracks@neutralWithoutGammaPtSum");
  iEvent.put(std::move(chiCands_passExo16044GapsVeto),            "tracks@passExo16044GapsVeto");
  iEvent.put(std::move(chiCands_passExo16044DeadNoisyECALVeto),   "tracks@passExo16044DeadNoisyECALVeto");
  iEvent.put(std::move(chiCands_passPFCandVeto),                  "tracks@passPFCandVeto");
  iEvent.put(std::move(chiCands_passExo16044JetIso),              "tracks@passExo16044JetIso");
  iEvent.put(std::move(chiCands_passExo16044LepIso),              "tracks@passExo16044LepIso");
  iEvent.put(std::move(chiCands_passExo16044Tag),                 "tracks@passExo16044Tag");
  iEvent.put(std::move(chiCands_trackQualityUndef),               "tracks@trackQualityUndef");
  iEvent.put(std::move(chiCands_trackQualityLoose),               "tracks@trackQualityLoose");
  iEvent.put(std::move(chiCands_trackQualityTight),               "tracks@trackQualityTight");
  iEvent.put(std::move(chiCands_trackQualityHighPurity),          "tracks@trackQualityHighPurity");
  iEvent.put(std::move(chiCands_trackQualityConfirmed),           "tracks@trackQualityConfirmed");
  iEvent.put(std::move(chiCands_trackQualityGoodIterative),       "tracks@trackQualityGoodIterative");
  iEvent.put(std::move(chiCands_trackQualityLooseSetWithPV),      "tracks@trackQualityLooseSetWithPV");
  iEvent.put(std::move(chiCands_trackQualityHighPuritySetWithPV), "tracks@trackQualityHighPuritySetWithPV");
  iEvent.put(std::move(chiCands_trackQualityDiscarded),           "tracks@trackQualityDiscarded");
  iEvent.put(std::move(chiCands_trackQualitySize),                "tracks@trackQualitySize");
