...
#        wantSummary = cms.untracked.bool(True) # off by default
    ...
    if sidecar:
            ...
            VectorDouble.extend(['DisappearingTracks:chiCands@matchedCaloEnergyJets(chiCands_matchedCaloEnergyJets)'])
            ...
            VectorBool.extend(['DisappearingTracks:chiCands@passExo16044DeadNoisyECALVeto(chiCands_passExo16044DeadNoisyECALVeto)']) 
            VectorBool.extend(['DisappearingTracks:chiCands@passExo16044GapsVeto(chiCands_passExo16044GapsVeto)'])
            VectorBool.extend(['DisappearingTracks:chiCands@passPFCandVeto(chiCands_passPFCandVeto)'])  
